# -*- coding:utf-8 -*-
###
# Created Date: Monday, June 25th 2018, 9:51:52 pm
# Author: John
...
class PostListView(ListView):
    ...
    def get_queryset(self):
        ...
        queryset = self.topic.posts.all().order_by('created_at')
        return queryset


@login_required
def reply_topic(request, pk, topic_pk):
    topic = get_object_or_404(Topic, board__id=pk, pk=topic_pk)
    if request.method == 'POST':
